...
Page.findPage = function (_pageid) {
  const index = pages.findIndex(function (current) {
    return _pageid === current.id;
  });
  if (index === -1) {
...
$('#toMenuPage').on('click', function () {
  showNewSection('#menu');
});
$('#toWordsPage').on('click', function () {
  showNewSection('#words');
});
// $("#toSoundPage").on("click", function() { showNewSection("#sound"); });
$('#toVisionPage').on('click', function () {
  showNewSection('#vision');
});
$('#toInfoPage').on('click', function () {
  showNewSection('#info');
});
$('#toVideoPage').on('click', function () {
  showNewSection('#video');
});
$('#toStillsPage').on('click', function () {
  showNewSection('#stills');
});
$('#toMapPage').on('click', function () {
  showNewSection('#sitemap');
});
$('#toDiaryPage').on('click', function () {
  showNewSection('#diary');
});
$('#toBlogPage').on('click', function () {
  showNewSection('#blog');
});
$('#toLoopPage').on('click', function () {
  showNewSection('#loop');
});

$('#SoundBackButton').on('click', function () {
  showNewSection('#menu');
});
$('#WordBackButton').on('click', function () {
  showNewSection('#menu');
});
$('#VisionBackButton').on('click', function () {
  showNewSection('#menu');
});
$('#InfoBackButton').on('click', function () {
  showNewSection('#menu');
});

$('#VideoBackButton').on('click', function () {
  showNewSection('#vision');
});
$('#VideoBackButton2').on('click', function () {
  showNewSection('#vision');
});
$('#VideoBackButton3').on('click', function () {
  showNewSection('#vision');
});
$('#VideoBackButton4').on('click', function () {
  showNewSection('#vision');
});
$('#VideoBackButton5').on('click', function () {
  showNewSection('#vision');
});
